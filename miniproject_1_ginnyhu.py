...
def get_sorted_cosine_similarity(embeddings_metadata):
    ...
    if embeddings_metadata["embedding_model"] == "glove":
        ...
        for index, category in enumerate(categories):
            ...
            sim_score = cosine_similarity(input_embedding, category_embedding)

            cosine_sim.append((index, sim_score))
        ...
        ##########################################
        input_embedding = get_sentence_transformer_embeddings(input_sentence, model_name=model_name)
